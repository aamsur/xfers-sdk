...
import { CloseButton } from 'XfersBasicComponents'
...
function Modal({header, body, children, footer, showModal, closeModal, customClass, showExitOnBody, backHandler}) {

  let modalClass = cx(customClass, classes.modal);
